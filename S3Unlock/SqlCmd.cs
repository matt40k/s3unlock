...
namespace Matt40k.S3Unlock
{
    public class SqlCmd
    {
        ...
        /// <summary>
        ///     Queryies the S3 database for status of deployments with the status code of InProgress (2) and RollBackInProgress
        ///     (9)
        ...
        ///     status is InProgress (2) or RollBackInProgress (9) to Failed (4) where the 'distributed_deployment_plan_guid'
        ///     matches
        /// </summary>
